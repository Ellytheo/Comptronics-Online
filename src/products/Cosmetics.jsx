...
const Cosmetics = () => {
  ...
  // Fetch data from multiple API endpoints for different categories
  const getProducts = async () => {
    ...
    try {
      const responses = await Promise.all([
        axios.get("https://0909El.pythonanywhere.com/api/get_nail_care"),
        axios.get("https://0909El.pythonanywhere.com/api/get_personal_care"),
        axios.get("https://0909El.pythonanywhere.com/api/get_hair_care"),
        axios.get("https://0909El.pythonanywhere.com/api/get_body_care"),
        axios.get("https://0909El.pythonanywhere.com/api/get_face_care"),
        axios.get("https://0909El.pythonanywhere.com/api/get_wellness_care"),
        axios.get("https://0909El.pythonanywhere.com/api/get_fragrances"),
      ]);
  ...
  const generateUniqueKey = (productId, category) => {
    return `${productId}-${category}`; // Create unique key using productId and category
  };
  ...
  return (
    <div className="container-fluid">
      <h1>Explore Cosmetics Products</h1>
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <button
                      ...
                      onClick={() => handleAddToCart(product, 'cosmetics')}
                    >
